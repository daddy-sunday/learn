...
public class DefaultRpcClient {
  ...
  public static DataResponest dataRequest(String url, DataRequest request)
      throws RemotingException, InterruptedException {
  ...
  public static DataResponest dataRequest(String url, DataRequest request, int timeOut)
      throws RemotingException, InterruptedException {
    return (DataResponest) client.invokeSync(url, request, timeOut);
  }

  public static RaftRpcResponest sendMessage(String url, RaftRpcRequest request)
      throws RemotingException, InterruptedException {
